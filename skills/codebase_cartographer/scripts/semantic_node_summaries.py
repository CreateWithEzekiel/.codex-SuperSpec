...
from cartographer_common import attach_fingerprints, deterministic_fingerprint, guess_language, read_text, should_skip_path, write_json
...
GRAPH_PATH = "visualiser/public/codebase_cartographer/graph.json"
...
def normalise_points(points: object, limit: int = 8) -> list[str]:
